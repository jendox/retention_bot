...
def delete_client_warning(*, t: Translator = _noop_t) -> str:
    return t(
        ...
        "После удаления пользоваться ботом как клиент, а также восстановить данные будет НЕВОЗМОЖНО.\n\n"
        "Удалить данные?",
    )
...
def delete_master_warning(*, t: Translator = _noop_t) -> str:
    return t(
        ...
        "После удаления пользоваться ботом как мастер, а также восстановить данные будет НЕВОЗМОЖНО.\n\n"
        "Удалить данные?",
    )
